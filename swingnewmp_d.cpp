...
int main()
{
	...
	double tint,tfin,omega0,*omega,*delta,*a,c_h,f_h,dint,*fine_delta,*fine_omega,*del_fine,*omega_fine;
	double t1,t2,t3,t4,et[110],tet[10],faverage,fsum;
	double *pred_delt,*corec_delt,*pred_omega,*corec_omega,delta_temp,omega_temp,*fine_tempd,*fine_tempo,*del_diff,*omega_diff,tempd,tempo;
	tint = 0.5;
	tfin = 102.9;
	dint = 26.39;
	...
	omega=(double*)_mm_malloc((num_steps*sizeof(double)),64);
	delta = (double*)_mm_malloc((num_steps*sizeof(double)),64);
	a = (double*)_mm_malloc((num_steps*sizeof(double)),64);
	fine_delta =(double*)_mm_malloc((num_steps*sizeof(double)),64);
	fine_omega = (double*)_mm_malloc((num_steps*sizeof(double)),64);
	del_fine = (double*)_mm_malloc((num_steps*sizeof(double)),64);
	omega_fine = (double*)_mm_malloc((num_steps*sizeof(double)),64);
	fine_tempd= (double*)_mm_malloc((fine_size*sizeof(double)),64);
	fine_tempo=(double*)_mm_malloc((fine_size*sizeof(double)),64);
	pred_delt= (double*)_mm_malloc((num_steps*sizeof(double)),64);
	pred_omega= (double*)_mm_malloc((num_steps*sizeof(double)),64);
	corec_delt=(double*)_mm_malloc((num_steps*sizeof(double)),64);
	corec_omega = (double*)_mm_malloc((num_steps*sizeof(double)),64);
	del_diff =(double*)_mm_malloc((num_steps*sizeof(double)),64);
	omega_diff = (double*)_mm_malloc((num_steps*sizeof(double)),64);
